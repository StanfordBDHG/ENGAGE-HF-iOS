//
// This source file is part of the ENGAGEHF based on the Stanford Spezi Template Application project
//
...
class OnboardingTests: XCTestCase {
    override func setUpWithError() throws {
        ...
        app.deleteAndLaunch(withSpringboardAppName: "ENGAGEHF")
    }
...
extension XCUIApplication {
    func conductOnboardingIfNeeded(email: String = "leland@stanford.edu") throws {
        ...
        if app.staticTexts["Spezi\nENGAGEHF"].waitForExistence(timeout: 5) {
            try app.navigateOnboardingFlow(email: email)
        }
    }
